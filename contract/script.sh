...
CONTRACT_NAME="CycleStark"
PROFILE_NAME="account1"
MULTICALL_FILE="multicall.toml"
FAILED_TESTS=false

# Addresses and Private keys as environment variables
ACCOUNT1_ADDRESS=${ACCOUNT1_ADDRESS:-"0x7cb9c66409c056b547c524b80f1c11915dcfc7f5dfc8d76f974b843dfa19291"}
ACCOUNT2_ADDRESS=${ACCOUNT2_ADDRESS:-"0x2972934e12b57b94f50bc3acb283468a4cb89b45c207f316108a5b62a692f78"}
ACCOUNT1_PRIVATE_KEY=${ACCOUNT1_PRIVATE_KEY:-"0x18d3867541fa6a6e7eee9beeeba9caa3"}
ACCOUNT2_PRIVATE_KEY=${ACCOUNT2_PRIVATE_KEY:-"0xeb34938f2ba053be079aba968f0b59b9"}
